...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('robust/app-assets/css/pages/coming-soon.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
...
<!--/ coming soon flat design -->
    ...
    <script src="{{asset('robust/app-assets/vendors/js/coming-soon/jquery.countdown.min.js')}}" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{asset('robust/app-assets/js/scripts/coming-soon/coming-soon.js')}}" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>
