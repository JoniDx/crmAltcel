...
@section('content')
                        ...
                        <div class="form-group"  style="padding-right: 1rem; padding-left: 1rem;">
                            ...
                            <div class="col md-12">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control form-control-sm mr-2" name="lastname" >
                                </div>
                                <div class="col-md-6 ">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <input type="text" class="form-control form-control-sm mr-2" name="telefono" >
                                </div>
                                <div class="col-md-6 ">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$dealer->name}} {{$dealer->lastname}}</td>
    ...
    <script>
        ...
        $('#add_update_balance').click(function(){
            ...
            let url = "{{route('dealer.update')}}";

            $.ajax({
                url: url,
                method: 'POST',
                data: {_token:token, saldo:balanceExtra, recharge: 1, id: id},
                beforeSend: function(){
                    swal_loading('Estamos trabajando en ello...', 'Espera un poco, un poquito más...')
                },
                success: function(response){
                    // console.log(response);
                    if(response.http_code == 1){
                        $('#balance-'+id).html('$'+parseFloat(balance).toFixed(2));
                        swal_succes('success', response.message)
                    }else if(response.http_code == 0){
                        swal_error('Oopps!', response.message)
                    }
                }
            });
        });
