...
<script>
    ...
    function copyToClickBoard(){
        ...
        window.open('https://api.whatsapp.com/send?phone=52'+cellphone+'&text=Hola, este es el link para completar tu pago en lí­nea por tu cambio de plan: '+content, '_blank');
    }
    ...
    function copyToClickBoardTwo(){
        ...
        window.open('https://api.whatsapp.com/send?phone=52'+cellphone+'&text=Hola, este es el link para completar tu pago en lí­nea por tu compra de GBs: '+content, '_blank');
    }
...
<script>
    ...
    (function( $ ) {
        ...
        $w6finish.on('click', function( ev ) {
            ...
            let offer_name_stripe = $('#ratesPurchaseProduct option:selected').attr('data-name');
            ...
            if($('input[name="purchaseProductRadio"]').is(':checked')) {
                if(validated){
                    ...
                    if(radioOption == 'purchaseProductFree' || radioOption == 'purchaseProductCollect'){
                        ...
                        data = {
                            _token:token, offer_name:offer_name_stripe, stripe_id:stripe_id, number_id: number_id, name: name, lastname: lastname, email: email,
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                packsSurplus.forEach(function(element){
                    options+="<option value='"+element.offerID+"' data-name='"+element.name+"' data-stripe='"+element.stripe_id_product+"' data-rate-price='"+element.price_sale+"' data-rate-id='"+dataMSISDN.rate_id+"' data-offer-id='"+element.id+"'>"+element.name+" - $"+parseFloat(element.price_sale).toFixed(2)+"</option>"
                })
