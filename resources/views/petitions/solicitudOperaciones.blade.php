        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-default">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$solicitud['icc']}}</td>
                    <td>{{$solicitud['imei']}}</td>
                    <td>{{$solicitud['serial_number']}}</td>
                    <td>{{$solicitud['mac_address']}}</td>
                    <td>
                        @if($solicitud['type'] == 'local')
                        <button class="btn btn-warning solicitud" id="notification" data-id="{{$solicitud['id']}}" data-client="{{$solicitud['id_client']}}" data-comment="{{$solicitud['comment']}}" data-lada="{{$solicitud['lada']}}" data-icc="{{$solicitud['icc']}}" data-imei="{{$solicitud['imei']}}" data-serie="{{$solicitud['serial_number']}}" data-mac="{{$solicitud['mac_address']}}" data-rate-activation="{{$solicitud['rate_activation']}}" data-rate-id="{{$solicitud['rate_id']}}">Activar</button>
...
<script>
    $('.solicitud').click(function(){
        ...
        let no_serie = $(this).attr('data-serie');
        let mac = $(this).attr('data-mac');

        let rate_name = $(this).attr('data-rate-activation');
        let rate_id = $(this).attr('data-rate-id');
        // console.log(rateId);
        // return false;

        console.log(id_petition);
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                let url = route+'?from=petition&name='+name+'&lastname='+lastname+'&rfc='+rfc+'&date_born='+date_born+'&address='+address+'&email='+email+'&ine_code='+ine_code+'&cellphone='+cellphone+'&petition='+id+'&lada='+lada+'&icc='+icc+'&imei='+imei+'&no_serie='+no_serie+'&mac='+mac+'&rate_name='+rate_name+'&rate_id='+rate_id;
                // console.log(url);
                location.href=url;
            }
        })
