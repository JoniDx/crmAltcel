	...
	(function() {
		var target = $('#gaugeBasic'),
			opts = $.extend(true, {}, {
				...
				colorStart: '#003cea', // Colors
				colorStop: '#003cea', // just experiment with them
